...
public class ElasticsearchTests {
    ...
    public void testInsertList() {
        ...
        discussRepository.saveAll(discussMapper.selectDiscussPostList(101, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(102, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(103, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(111, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(112, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(131, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(132, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(133, 0, 100, 0));
        discussRepository.saveAll(discussMapper.selectDiscussPostList(134, 0, 100, 0));
    }
